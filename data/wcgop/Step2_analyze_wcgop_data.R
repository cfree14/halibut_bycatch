...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_wcgop_trawl_obs_bycatch_ratio_by_species_discards.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_wcgop_trawl_obs_bycatch_ratio_over_time_discards.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_wcgop_trawl_obs_bycatch_ratio_by_depth_discards.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_wcgop_trawl_obs_bycatch_ratio_by_yday_discards.png"),
       width=6.5, height=5.5, units="in", dpi=600)
