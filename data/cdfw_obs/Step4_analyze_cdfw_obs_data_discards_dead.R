...
data <- data_orig %>%
  ...
  summarize(catch_n=sum(n_kept, na.rm=T),
            discards_n=sum(n_discarded_dead)) %>%
  ungroup() %>%
  # Halibut bycatch
  group_by(set_id) %>%
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_cdfw_gillnet_obs_bycatch_ratio_by_species_discards_dead.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_cdfw_gillnet_obs_bycatch_ratio_over_time_discards_dead.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_cdfw_gillnet_obs_bycatch_ratio_by_depth_discards_dead.png"),
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigX_cdfw_gillnet_obs_bycatch_ratio_by_date_discards_dead.png"),
       width=6.5, height=5.5, units="in", dpi=600)
